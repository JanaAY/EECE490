        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest findings and model performance</CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="accuracy">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="text-lg">DR Detection Model</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="text-3xl font-bold text-blue-700">97.8%</div>
                        <p className="text-sm text-gray-500">Accuracy on validation dataset</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="text-lg">Vessel Mapping</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="text-3xl font-bold text-blue-700">95.2%</div>
                        <p className="text-sm text-gray-500">Precision in vessel detection</p>
                      </CardContent>
                    </Card>
                  </div>
                </TabsContent>
                <TabsContent value="findings" className="pt-4">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Early-stage DR detection improved by 23% using our novel vessel mapping approach</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <FileText className="h-5 w-5 text-blue-700 mt-0.5 flex-shrink-0" />
                      <span>Automated grading system achieves 91% concordance with expert ophthalmologists</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <FileText className="h-5 w-5 text-blue-700 mt-0.5 flex-shrink-0" />
                      <span>New preprocessing technique reduces false negatives by 17%</span>
                    </li>
                  </ul>
                </TabsContent>
                <TabsContent value="publications" className="pt-4">
                  <ul className="space-y-4">
                    <li>
                      <h3 className="font-medium">Advanced Deep Learning for Diabetic Retinopathy Detection</h3>
                      <p className="text-sm text-gray-500">Journal of Medical Imaging, 2023</p>
                    </li>
                    <li>
                      <h3 className="font-medium">Vessel Mapping Techniques for Early DR Diagnosis</h3>
                      <p className="text-sm text-gray-500">Ophthalmology Research, 2023</p>
                    </li>
                    <li>
                      <h3 className="font-medium">Comparative Analysis of DR Detection Models</h3>
                      <p className="text-sm text-gray-500">AI in Medicine, 2022</p>
                    </li>
                  </ul>
                </TabsContent>
              </Tabs>
